...
function calcResult(event) {
    ...
    const inputValue = _viewJs.UI_ELEMENTS.INPUT.valueAsNumber;
    const nowDate = new Date();
    const inputDate = _dateFns.fromUnixTime(inputValue / 1000);
    const isDatePast = _dateFns.isBefore(inputDate, nowDate);
    const output = _dateFns.intervalToDuration({
        start: nowDate,
        end: inputDate
    });
    const { years , hours  } = output;
    const days = _dateFns.formatDistanceStrict(nowDate, inputDate, {
        unit: 'day'
    });
    if (isDatePast) _viewJs.UI_ELEMENTS.RESULT.textContent = `Was ${years} years, ${parseInt(days) - 365 * years} days and ${hours} hours ago`;
    else _viewJs.UI_ELEMENTS.RESULT.textContent = `Will come ${years} years, ${parseInt(days) - 365 * years} days and ${hours} hours`;
}
_viewJs.UI_ELEMENTS.FORM.addEventListener('submit', calcResult);
...
},{"../toDate/index.js":"fsust","../differenceInCalendarYears/index.js":"f4WIY","../compareAsc/index.js":"h01l4","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gN5ZD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../_lib/getTimezoneOffsetInMilliseconds/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../_lib/getTimezoneOffsetInMilliseconds/index.js":"bc74C","../compareAsc/index.js":"h01l4","../toDate/index.js":"fsust","../_lib/cloneObject/index.js":"PgZBT","../locale/en-US/index.js":"8XKCq","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"PgZBT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/toInteger/index.js":"f7kKX","../addMonths/index.js":"hES3W","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4VQv8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jWVwA","6rimH"], "6rimH", "parcelRequire4482")
